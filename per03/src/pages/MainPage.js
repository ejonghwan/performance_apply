...
function MainPage(props) {
	...
	useEffect(() => {
		...
		observer.observe(imgRef_1.current);
		observer.observe(imgRef_2.current);
		observer.observe(imgRef_3.current);
	...
	return (
		<div className="MainPage -mt-16">
			...
			<div className="mx-auto">
				...
				<ThreeColumns
					columns={[
						<Card webp={main1} image={main1}>롱보드는 아주 재밌습니다.</Card>,
						<Card webp={main2} image={main2}>롱보드를 타면 아주 신납니다.</Card>,
						<Card webp={main3} image={main3}>롱보드는 굉장히 재밌습니다.</Card>
					]}
				/>
